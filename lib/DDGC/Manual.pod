...
The community platform of L<https://duckduckgo.com/|DuckDuckGo> at
...
As template engine, we use L<Text::Xslate>. We use L<http://prosody.im/|prosody>
...
other XMPP users in the world. As webserver we use L<http://nginx.org/|nginx>,
...
options we offer more information on our L<http://duck.co/help|help pages> or
in L<http://duck.co/blog|the DuckDuckGo blog>.
