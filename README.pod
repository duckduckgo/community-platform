...
To start, you must once initialize the base database. The default is to use
...
bashrc or correspdonding initialization scripts for your shell):
...
process has to be repeated everytime the country flags are changing.
